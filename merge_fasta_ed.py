...
Run this script after separate fasta and qual files (see convert_fastaqual_fastq.py from qiime)
...
#input files:
#indexes_file = str(sys.argv[1])
#indexes = pandas.read_csv(samples_indexes)
